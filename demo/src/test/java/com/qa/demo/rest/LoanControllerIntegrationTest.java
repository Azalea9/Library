...
public class LoanControllerIntegrationTest {
	...
	public void init() {
		...
		List<Loan> loans =  List.of(
                ...
                testLoan = new Loan(3L,1L,1L,LocalDate.now(),LocalDate.now().plusDays(21));
                testLoanChanged = new Loan(2L,2L, 1L,LocalDate.now(),LocalDate.of(2022, 10, 22));
                savedLoan = new Loan(3L,1L, 1L,LocalDate.now(),LocalDate.now().plusDays(21));
